...
# Function to set up routes that will be imported in main.py
def setup_notification_routes(app, db):
    ...
    # Return function to be used in other modules
    return send_message_notifications